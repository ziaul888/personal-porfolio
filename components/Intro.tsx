...
>
  ...
  <span className="font-bold">2+ years</span> of experience. I specialize in building{" "}
  <span className="italic">responsive and user-friendly web applications</span>, with a strong focus on{" "}
